<?php
class Order_LinerorderController extends Core2_Controller_Action_Fr 
{
    /**
     * 初始化
     */
	...
	public function confirmAction() 
	{
		...
		$result = $this->_db->select()
		      ...
		      ->where('p.id in (?)',$this->params['room_ids'])
		      ->query()
		      ->fetchAll();
	...
	public function ajaxAction()
	{
	    ...
	    switch ($op)
	    {
	        case 'create':
	            ...
	            $this->json['errno'] = '0';
	            $this->json['url'] = "/order/order/list";
	            $this->_helper->json($this->json);
