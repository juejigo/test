{include file='public/admincp/header.tpl'}{include file="public/admincp/siderbar.tpl"}
	...
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">新增客服 <small>添加一个新的客服</small></h3>
			<!--路径导航-->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="/servicecp/staff/list">专属客服</a><i class="fa fa-angle-right"></i></li>
					<li><a href="/servicecp/staff/add">新增客服</a></li>
				</ul>
			</div>
			<!-- 错误提醒 -->
				{if $error->hasError()}
							...
							<div class="tab-content">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-4"><input type="text" class="form-control" name="staff_name" placeholder="请输入客服姓名，不超过14个字"></div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">照片： </label>
										<div class="col-md-4"><input data-toggle="modal" data-target="#image_uploader" name="image" class="form-control" placeholder="点击上传照片"><a href="javascript:;" class="lookimg btn default">预览</a></div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">微信：</label>
										<div class="col-md-4"><input type="text" class="form-control" name="wx"></div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
                                        	<textarea class="form-control ke" rows="4" name="introduce"></textarea>
										</div>
									</div>
								</div>
							</div>
