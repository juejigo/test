...
<!--content-wrapper-->
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">添加子签证 <small>添加一个新的子签证</small></h3>
							<!-- 错误提醒 -->
				{if $error->hasError()}
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="/productcp/visa/childeradd?parent_id={$parent_id}">添加签证</a></li>
				</ul>
			</div>
			<!--表单-->
			<div class="row">
				<div class="col-md-12">
					<form action="/productcp/visa/childeradd" class="form-horizontal form-row-seperated" method="post">
						<div class="portlet">
	                                        ...
	                                        <div class="dataTables_wrapper no-footer">
												<div class="table-scrollable">
													<table class="table table-bordered table-hover">
														...
														<tbody id="tbody">
															<tr data-id="1">
																<td><input type="text" class="form-control" name="items[1][info_name]"></td>
																<td><input type="text" class="form-control" name="items[1][info_type]"></td>
																<td><input type="text" class="form-control" name="items[1][info_total]"></td>
																<td><textarea name="items[1][info]" class="form-control"></textarea></td>
																<td>
																	<button type="button" class="btn green upload">上传附件 <i class="fa fa-plus"></i></button>
																	<input type="hidden" name="items[1][info_file]"><a href='' class="btn blue">查看</a>
																</td>
