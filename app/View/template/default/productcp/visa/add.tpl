		...
		<div class="page-content" style="min-height:812px">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="/productcp/visa/add">添加签证</a></li>
				</ul>
			</div>
			<!--表单-->
			<div class="row">
				<div class="col-md-12">
					<form action="/productcp/visa/add" class="form-horizontal form-row-seperated" method="post">
						<div class="portlet">
							...
							<div class="tab-content">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-8"><input type="text" class="form-control" name="visa_name"></div>
									</div>
									<div class="form-group">
	                                    <label class="col-md-2 control-label">备注：</label>
	                                    <div class="col-md-8">
	                                        <textarea class="form-control ke" name="content" rows="10"></textarea>
	                                    </div>
	                                </div>
								</div>
							</div>
