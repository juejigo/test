				...
				<div class="col-md-12">
					<div class="portlet-body">
						...
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<a class="btn green" href="/productcp/contract/add">新增 <i class="fa fa-plus"></i></a>
								</div>
							</div>
						</div>
						<!--表格-->
								...
								<table class="table table-striped table-bordered table-hover">
									...
									{foreach  $contractList as $i=>$row}
										<tr data-id="{$row.id}"> 
											...
											<td>
												<a href="/productcp/contract/edit?id={$row.id}" class="btn green">编辑 <i class="glyphicon glyphicon-edit"></i></a>
...
$('.delete').click(function(){
	...
	if (confirm('确定删除？')){
		$.post('/productcp/contract/delete?id='+id,function(data){
			if (data.errno == 1){
				tr.remove();
				return;
			}else{
