...
<!--content-wrapper-->
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">添加保险 <small>添加一个新的保险</small></h3>
							<!-- 错误提醒 -->
				{if $error->hasError()}
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="/productcp/addon/add">添加保险</a></li>
				</ul>
			</div>
			<!--表单-->
			<div class="row">
				<div class="col-md-12">
					<form action="/productcp/addon/add" class="form-horizontal form-row-seperated" method="post">
						<div class="portlet">
							...
							<div class="tab-content">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-8"><input type="text" class="form-control" name="addon_name"></div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
	                                    ...
	                                    <div class="col-md-8">
	                                        <textarea class="form-control ke" name="info"></textarea>
	                                    </div>
	                                </div>
								</div>
							</div>
