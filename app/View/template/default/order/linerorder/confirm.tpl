  ...
  <div class="main">
      <form id="orderFill" class="pt45" action="/order/linerorder/ajax?op=create">
        ...
        {foreach $params.room_ids as $i=>$row}
        <input type="hidden" name="room_ids[{$i}][id]" value="{$row.id}" placeholder="邮轮房间ID">
        {/foreach}
        ...
        <div class="order_left">
          ...
          <div class="order_info">
            ...
            <div class="order_form">
              ...
              <div class="row clearfix"> 
                <div class="l">邮轮房型：</div>
                <div class="r"> {$row.addon_name}</div>
              </div>
              {/foreach}
              <div class="row clearfix">
                <div class="l">备注：</div>
