...
<div class="row">
		<div class="col-md-12">
				...
				<form method="post" class="form-horizontal form-row-seperated" action="/positioncp/data/edit?id={$params.id}">
								...
								<div class="portlet-body form">
										...
										<div class="form-body">
												...
												<div style="display:block;" class="form-group">
													<label class="col-md-2 control-label">上架时间<input type="checkbox" id="upcheck" {if $data.up_time != 0}checked="checked"{/if} class="group-checkable checkbox"></label>
													<div class="col-md-10">
															<input type="text" class="form-control form_datetime" name="up_time" value="{date("Y-m-d H:i",$data.up_time)}" {if $data.up_time == 0}readonly="readonly"{/if}>
													</div>
												</div>
												
												<div style="display:block;" class="form-group">
													<label class="col-md-2 control-label">下架时间<input type="checkbox" id="downcheck" {if $data.down_time != 0}checked="checked"{/if}class="group-checkable checkbox"></label>
													<div class="col-md-10">
															<input type="text" class="form-control form_datetime" name="down_time" value="{date("Y-m-d H:i",$data.down_time)}" {if $data.down_time == 0}readonly="readonly"{/if}>
													</div>
												</div>
												...
												<div {if $data.data_type == 'product_list'}style="display:block;"{/if} class="product_list params form-group">
													...
													<div id="cate_selector" class="col-md-10">
															<select class="form-control" name="params[cate_id]">
																	...
																	<option style="text-indent:{($cateList.{$cate.id}.level - 1) * 10}px;" {if !empty($data.params.cate_id) && $cate.id == $data.params.cate_id}selected="selected"{/if} value="{$cate.id}">{$cate.value}</option>
																	{/foreach}
															</select>
													</div>
												</div>
