						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a class="btn green" href="/positioncp/position/groupadd">
							...
							<tbody>
							{foreach $groupList as $i => $position}
							<tr dataid="{$position.id}" class="{if $i/2 == 1}odd{/if} gradeX">
								...
								<td>
									<a href="/positioncp/position/groupedit?id={$position.id}" class="btn green">编辑 <i class="glyphicon glyphicon-edit"></i></a>
									<a href="/positioncp/position/list?group_id={$position.id}" class="btn green">查看内容 <i class="glyphicon glyphicon-list-alt"></i></a>
								</td>
							</tr>
							{/foreach}
							</tbody>
