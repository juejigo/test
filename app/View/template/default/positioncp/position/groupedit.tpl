...
<div class="row">
		<div class="col-md-12">
				...
				<form method="post" class="form-horizontal form-row-seperated" action="/positioncp/position/groupedit?id={$params.id}">
								...
								<div class="portlet-body form">
										...
										<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-10">
															<input type="text" class="form-control" name="group_name" placeholder="" value="{$data.group_name}">
													</div>
												</div>
