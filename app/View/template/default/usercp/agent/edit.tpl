...
<link rel="stylesheet" href="{$smarty.const.URL_MIX}metronic3.6/global/plugins/select2/select2.css">
	...
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">编辑代理商 <small>编辑代理商</small></h3>
			<!--路径导航-->
			<div class="page-bar">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="" class="form-horizontal form-row-seperated" method="post">
						<div class="portlet">
							<div class="portlet-title">
								...
								<div class="pull-right">
									<a href="/usercp/agent/list" class="btn default"><i class="fa fa-angle-left"></i> 返回</a>
						...
						<div class="portlet-body form">
							<div class="tab-content">
								<input type="hidden" name="id" value="1" placeholder="代理商ID">
								<div class="form-body">
									<div class="form-group">
										<label class="control-label col-md-2">代理商名称： </label>
										<div class="col-md-6"><input type="text" class="form-control" name="agent_name" value="{$editList['agent_name']}"></div>
									</div>
									<div class="form-group">
									<label class="control-label col-md-2">代理城市： </label>
										<div class="col-md-4">
										<select name="agent_city_id" class="form-control select2"><option value="0">请选择</option>
											{foreach $city as $v}
												<option {if $editList['region_id']==$v['id']} selected="selected" {/if} value="{$v['id']}">{$v['region_name']}</option>
											{/foreach}
										</select>
										</div>
                 				  </div>
                  ...
                  <div class="form-group">
										...
										<div class="col-md-6"><input type="text" class="form-control" name="company_name" value="{$editList['company_name']}"></div>
									</div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
										...
										<div class="col-md-6"><input type="text" class="form-control" name="linkman" value="{$editList['linkman']}"></div>
									</div>
                  <div class="form-group">
										<label class="control-label col-md-2">联系手机： </label>
										<div class="col-md-6"><input type="text" class="form-control" name="linkman_mobile" value="{$editList['linkman_mobile']}"></div>
									</div>
                  <div class="form-group">
