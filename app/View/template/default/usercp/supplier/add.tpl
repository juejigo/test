{include file='public/admincp/header.tpl'}{include file="public/admincp/siderbar.tpl"}
	...
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">新增供应商 <small>添加一个新的供应商</small></h3>
			<!--路径导航-->
			<div class="page-bar">
			...
			<div class="row">
				<div class="col-md-12">
							...
							<div class="tab-content">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-6"><input type="text" class="form-control" name="supplier_name"></div>
									</div>
                  <div class="form-group">
                      <label class="col-md-2 control-label">省市区：</label>
                      <div class="col-md-10">
                          <div class="select_region">
                              <select name="province_id" class="form-control input-small input-inline"><option value="0">请选择</option></select>
                              <select name="city_id" class="form-control input-small input-inline"><option value="0">请选择</option></select>
                              <select name="county_id" class="form-control input-small input-inline"><option value="0">请选择</option></select>
                          </div>
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
										...
										<div class="col-md-6"><textarea name="intro" class="form-control ke" rows="5"></textarea></div>
									</div>
				 <div class="form-group">
