...
<div class="row">
		<div class="col-md-12">
				...
				<form method="post" class="form-horizontal form-row-seperated" action="/usercp/member/edit?id={$params.id}">
						<div class="portlet">
								<!-- portlet-title /-->
												...
												<div role="tabpanel" class="tab-pane active" id="base_pane">
														...
														<div class="form-body">
																<div class="form-group">
																	...
																	<div class="col-md-10">
																			<input type="text" class="form-control" name="referee_id" placeholder="" value="{$data.referee_id}">
																	</div>
																</div>
