{include file='public/admincp/header.tpl'}{include file="public/admincp/siderbar.tpl"}
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">新增等级 <small>添加一个新的等级</small></h3>
			<!--路径导航-->
			<div class="page-bar">
							...
							<div class="tab-content">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-3"><input type="text" class="form-control" name="name" placeholder="不超过20个字"></div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-3">
											<select name="role" class="form-control" required="">
												...
												{foreach $role as $v}
													<option value="{$v['role']}">{$v['role_name']}</option>
												{/foreach}
