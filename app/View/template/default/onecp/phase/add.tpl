...
<script type="text/javascript" src="{$smarty.const.URL_MIX}metronic3.6/global/plugins/bootstrap_datetimepicker/js/bootstrap-datetimepicker.min.js" charset="UTF-8"></script>
	...
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">添加期数 <small>新建期数</small></h3>
			<!--路径导航-->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="/onecp/phase/add">添加期数</a></li>
				</ul>
			</div>
			{if $error->hasError()}
			...
			<div class="row">
				<div class="col-md-12">
					<form action="/onecp/phase/add" class="form-horizontal form-row-seperated" method="post">
						<div class="portlet">
							...
							<div class="tab-content">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-6"><input type="text" class="form-control" name="product_id" placeholder="请输入对应商品ID" value="{$data.product_id}"></div>
									</div>
                  					<div class="form-group">
										<label class="control-label col-md-2">商品名称 </label>
										<div class="col-md-6"><input type="text" class="form-control" name="product_name" placeholder="请输入商品名称" value="{$data.product_name}"></div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">商品图片 </label>
										<div class="col-md-6"><input data-toggle="modal" data-target="#image_uploader" name="image" class="form-control" placeholder="点击添加图片" value="{$data.image}"></div>
									</div>
                 				 	<div class="form-group">
										<label class="control-label col-md-2">商品期数 </label>
										<div class="col-md-6"><input type="text" class="form-control" name="num" placeholder="请输入商品期数" value="{$data.num}"></div>
									</div>
                 					<div class="form-group">
										<label class="control-label col-md-2">商品价格 </label>
										<div class="col-md-6"><input type="text" class="form-control" name="product_price" placeholder="请输入对应商品价格" value="{$data.product_price}"></div>
									</div>
                 					 <div class="form-group">
										<label class="control-label col-md-2">夺宝价 </label>
										<div class="col-md-6"><input type="text" class="form-control" name="price" placeholder="请输入夺宝价" value="{$data.price}"></div>
									</div>
                  					<div class="form-group">
										<label class="control-label col-md-2">限购 </label>
										<div class="col-md-6"><input type="text" class="form-control" name="limit_num" placeholder="请输入限购次数" value="{$data.limit_num}"></div>
									</div>
                  					<div class="form-group">
										<label class="control-label col-md-2">开始时间 </label>
										<div class="col-md-6"><input type="text" class="form-control form_datetime" name="start_time" placeholder="开始时间" value="{$data.start_time}"></div>
									</div>
                  					<div class="form-group">
										<label class="control-label col-md-2">结束时间 </label>
										<div class="col-md-6"><input type="text" class="form-control form_datetime" name="end_time" placeholder="结束时间" value="{$data.end_time}"></div>
									</div>
								</div>
							</div>
						</div>
