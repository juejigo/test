...
<!-- 主体 -->
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">销售统计 <small>每月订单数量</small></h3>
			<!--路径导航-->
			<div class="page-bar">
...
function charts(startDate,endDate){
    ...
    $.ajax({
        url:'/statisticcp/order/ajax?op=sales',
        type:'post',
        data:{
        	dateline_from:start,
        	dateline_to:end
        ...
        if(data.success){
        	...
        	$("#orderSales").html("<div class='alert alert-warning'>没有数据</div>");
        }
    })
}
