{include file='public/admincp/header.tpl'}{include file="public/admincp/siderbar.tpl"}
	...
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			<!--标题栏-->
			<h3 class="page-title">添加选手 <small>新建一个新的参赛选手</small></h3>
			<!--路径导航-->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="/votecp/player/add?vp_id={$params.vp_id}">添加选手</a></li>
				</ul>
			</div>
			<!-- 错误提醒 -->
				{if $error->hasError()}
							...
							<div class="tab-content">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-4"><input type="text" class="form-control" name="name" placeholder="请输入真实姓名"></div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">个人照片 <span class="required" aria-required="true">*</span></label>
										<div class="col-md-4"><input data-toggle="modal" data-target="#image_uploader" name="image" class="form-control" placeholder="点击添加图片"></div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">参赛宣言</label>
										<div class="col-md-4"><input type="text" class="form-control" name="declaration" placeholder="参赛宣言"></div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">自我介绍</label>
										<div class="col-md-5">
											<textarea id="detail" name="introduction" class="form-control"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">选手票数</label>
										<div class="col-md-2"><input type="text" class="form-control" name="vote_num" placeholder="选手票数" value="">
										<span class="help-block">可以手动设置选手得票数</span></div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">联系方式</label>
										<div class="col-md-2"><input type="text" class="form-control" name="phone" placeholder="联系方式" value=""></div>
									</div>
									<div class="form-group">
									...
									<!-- <div class="form-group">
										...
										<div class="col-md-4">
											<textarea name="nopass"  class="form-control"></textarea>
										</div>
									</div> -->
								</div>
							</div>
