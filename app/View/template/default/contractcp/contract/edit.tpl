...
<!--content-wrapper-->
	<div class="page-content-wrapper">
		<div class="page-content" style="min-height:812px">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="/contractcp/contract/edit" class="form-horizontal form-row-seperated" method="post">
						<div class="portlet">
							...
							<div class="tab-content">
								<div class="form-body">
									...
									<div class="form-group">
	                                    ...
	                                    <div class="col-md-8">
	                                        <textarea class="form-control ke" name="content">{$contract.content}</textarea>
	                                    </div>
	                                </div>
								</div>
							</div>
