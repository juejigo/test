...
$alipay_config['seller_id']	= '2088221205434272';
...
$alipay_config['notify_url'] ='/pay/aliapp/notify2';

// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
$alipay_config['return_url'] =  '/order/order/list';
...
$alipay_config['cacert']    =  getcwd().'/lib/api/aliwappay/cacert.pem';
